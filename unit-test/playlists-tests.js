...
(async () => {
  ...
  console.assert(added, 'Error: La canción no fue agregada');
  ...
  console.assert(removed, 'Error: La canción no fue eliminada');
  ...
  console.assert(createPlaylistCalled, 'Error: createPlaylist no fue llamado');
  if (createPlaylistCalled) console.log('createPlaylist fue llamado correctamente');

  console.assert(!PlaylistComponent.isSavingPlaylist, 'Error: isSavingPlaylist debería ser false');
  ...
  createPlaylistCalled = false;
  await PlaylistComponent.createPlaylistAndSaveToSupabase();
  console.assert(!createPlaylistCalled, 'Error: createPlaylist debería NO haberse llamado');
